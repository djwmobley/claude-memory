...
| `test/handoff/test-reality-reconcile.js` | Tests for reality-mismatch reconcile (Part 1 + Part 2): R1 branch_exists 1:1 reconcile, R2 idempotency, R3 in_file 1:N reconcile + §7 no-backfill, R4 degraded_close retention prune | added |
